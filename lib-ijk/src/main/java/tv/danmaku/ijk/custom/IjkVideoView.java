...
public class IjkVideoView extends VideoView<CustomIjkMediaPlayer> {
    ...
    public void setEnableMediaCodec(boolean isEnable) {
        ...
        addPlayerOption("mediacodec", 1);
        addPlayerOption("mediacodec-all-videos", 1);
        addPlayerOption("mediacodec-sync", 1);
        addPlayerOption("mediacodec-auto-rotate", 1);
        addPlayerOption("mediacodec-handle-resolution-change", 1);
    }
